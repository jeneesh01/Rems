...
export const addPropertyData =
  <K extends keyof IPropertyDetail>(key: K, data: IPropertyDetail[K]) =>
...
export const getProperty = (id: string) => async (dispatch: AppDispatch) => {
...
export const addProperty =
  (body: any, onSuccess: (success: boolean) => void) =>
  async (dispatch: AppDispatch, getState: () => RootState) => {
...
export const chatBotApi =
  ...
  async (dispatch: AppDispatch, getState: () => RootState) => {
    ...
    const data = await PropertyService.chatBot(body);
    if (data.status) {
      showMessage({
        type: 'info',
        message: data.message,
