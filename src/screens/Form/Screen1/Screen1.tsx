    ...
    <View style={styles.container}>
      <KeyboardAwareScrollView
        ...
        <View style={{alignItems: 'center'}}>
          <TouchableOpacity
            ...
            {uriImage.length > 0 ? (
              <Image
                source={{uri: uriImage}}
                style={{height: 98, width: 98, borderRadius: 100}}
              />
            ) : (
              <Image
                source={images.LOGO}
        ...
        <HCustomTextInput
          ...
          setValue={text => onNameChange(text)}
        />
        <HCustomTextInput
          placeholder="Property Type"
          defaultValue={propertyData.property_type}
          setValue={text => onPTypeChange(text)}
        />
        <HCustomTextInput
          placeholder="Property Price"
          defaultValue={propertyData.price}
          setValue={text => onPriceChange(text)}
          keyboardType="number-pad"
        />
        <HCustomTextInput
          placeholder="Property Sqft"
          defaultValue={propertyData.sqft}
          setValue={text => onSqftChange(text)}
          keyboardType="number-pad"
        />
